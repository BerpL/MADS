		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 registro">
				<ul>
					...
					<li>|</li>
					<li><a href="#modalRegistro" data-toogle="modal">Crear una cuenta</a></li>
				</ul>
			</div>
		</div>
	...
	<div class="container">
		...
		<div class="row" id="cabezote">
			...
			<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12" id="logotipo">
				...
				<a href="#">
					<img src="http://localhost/MADS/backend/<?php echo $social["logo"];?>" class="img-responsive">
				</a>
			...
			<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12" id="carrito">
				...
				<p>TU CESTA 
					<span class="cantidadCesta">3</span><br>USD $ <span class="sumaCesta">20</span>
				</p>
			</div>
