...
<div class="container-fluid" id="slide">
	<div class="row">
		...
		<ul>
			<!-- SLIDE 1 -->
			<li>
				<img src="http://localhost/MADS/backend/vistas/img/slide/default/back_default.jpg">

				<div class="slideOpciones slideOpcion1">
					<img class="imgProducto" src="http://localhost/MADS/backend/vistas/img/slide/slide1/calzado.png" style="top:15%; right: 10%; width: 45%">
					<div class="textosSlide" style="top:20%; left: 10%; width: 40%">
						...
						<a href="#">
							<button class="btn btn-default backColor text-uppercase">
								VER PRUDCTO <span class="fa fa-chevron-right"></span>
			...
			<li>
				...
				<div class="slideOpciones slideOpcion2">
					<img class="imgProducto" src="http://localhost/MADS/backend/vistas/img/slide/slide2/curso.png" style="top:5%; left: 15%; width: 25%">
			...
			<!-- SLIDE 3 -->
			<li>
				<img src="http://localhost/MADS/backend/vistas/img/slide/slide3/fondo2.jpg">

				<div class="slideOpciones slideOpcion2">
					<img class="imgProducto" src="http://localhost/MADS/backend/vistas/img/slide/slide3/iphone.png" style="top:5%; left: 15%; width: 25%">
					<div class="textosSlide" style="top:20%; right: 10%; width: 40%">
			...
			<!-- SLIDE 4 -->
			<li>
				<img src="http://localhost/MADS/backend/vistas/img/slide/slide4/fondo3.jpg">
