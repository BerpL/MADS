...
<figure class="banner">
	...
	<img src="http://localhost/MADS/backend/vistas/img/banner/default.jpg" class="img-responsive" width="100%">
			...
			<div class="col-xs-12 organizarProductos">
				...
				<div class="btn-group pull-right">
					...
					<button type="button" class="btn btn-default btnGrid" id="btnGrid0">
						...
						<spam class="col-xs-0 pull-right"> GRID</spam>
					...
					<button type="button" class="btn btn-default btnList" id="btnList0">
						...
						<spam class="col-xs-0 pull-right"> LIST</spam>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/MADS/backend/vistas/img/productos/accesorios/accesorio04.jpg" class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/MADS/backend/vistas/img/productos/accesorios/accesorio03.jpg" class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/MADS/backend/vistas/img/productos/accesorios/accesorio02.jpg" class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/MADS/backend/vistas/img/productos/accesorios/accesorio01.jpg" class="img-responsive">
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img src="http://localhost/MADS/backend/vistas/img/productos/accesorios/accesorio04.jpg" class="img-responsive"></a>
				...
				<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
					...
					<p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi utr.</p>
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img src="http://localhost/MADS/backend/vistas/img/productos/accesorios/accesorio03.jpg" class="img-responsive"></a>
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img src="http://localhost/MADS/backend/vistas/img/productos/accesorios/accesorio02.jpg" class="img-responsive"></a>
				...
				<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
					...
					<h1>
						<small>
							...
							<a href="#" class="pixelProducto">Bolsa Militar</a>
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img src="http://localhost/MADS/backend/vistas/img/productos/accesorios/accesorio01.jpg" class="img-responsive"></a>
...
<div class="container-fluid productos well well-sm barraProductos">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/MADS/backend/vistas/img/productos/ropa/ropa03.jpg" class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/MADS/backend/vistas/img/productos/ropa/ropa04.jpg" class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/MADS/backend/vistas/img/productos/ropa/ropa02.jpg" class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/MADS/backend/vistas/img/productos/ropa/ropa06.jpg" class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/MADS/backend/vistas/img/productos/cursos/curso05.jpg" class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/MADS/backend/vistas/img/productos/cursos/curso04.jpg" class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/MADS/backend/vistas/img/productos/cursos/curso02.jpg" class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/MADS/backend/vistas/img/productos/cursos/curso03.jpg" class="img-responsive">
				...
				<li class="col-xs-12">
					...
					<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
						...
						<div class="btn-group pull-left enlaces">
							...
							<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="http://localhost/MADS/backend/vistas/img/productos/cursos/curso05.jpg" titulo="Curso de Bootstrap" precio="10" tipo="virtual" peso="0" data-toggle="tooltip" title="Agregar al carrito de compras">
